...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.ImageList1.Images.SetKeyName(7, "SadFloor.png")
        Me.ImageList1.Images.SetKeyName(8, "DirtFloor.png")
        Me.ImageList1.Images.SetKeyName(9, "SadWall(Front).png")
        Me.ImageList1.Images.SetKeyName(10, "SadWall(SmartBoard).png")
        ...
        Me.ImageList1.Images.SetKeyName(14, "RainbowTeacher(Front).png")
        Me.ImageList1.Images.SetKeyName(15, "SadTeacher(Front).png")
        Me.ImageList1.Images.SetKeyName(16, "SadStudent(Back).png")
        '
        'AL
        '
        '
